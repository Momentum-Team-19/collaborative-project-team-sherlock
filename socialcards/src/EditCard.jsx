...
const EditCard = ({ token }) => {
  ...
  axios
    .get(
      `https://social-cards.fly.dev/api/cards/${cardID}/styles/`,
      {
        headers: {
    ...
    .then((response) => {
      ...
      setCoverBackgroundColor(response.data.background_color)
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
        axios
          .request({
            url: `https://social-cards.fly.dev/api/cards/${cardID}/styles/edit/`,
            method: "PATCH",
            headers: {
              Authorization: `Token ${token}`,
            },
